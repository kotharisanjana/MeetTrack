from src.audio_to_text.asr import ASR, TranscriptSegments
from src.audio_to_text.diarization import Diarization, SpeakerSegments
...
class AudioProcessing:
    def __init__(self, session_data):
        ...
        self.diarization_obj = Diarization(self.meeting_id, self.local_audio_path, self.local_diarization_path)
