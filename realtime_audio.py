...
from setup import setup_obj, final_transcript_obj, vector_db_obj, text_embedding_obj
...
class RealtimeAudio:
    ...
    def realtime_audio_pipeline(self):
        ...
        audio_to_text_output = final_transcript_obj.combine_asr_diarization(speakers_obj.speaker_segments, asr_obj.transcript_segments)

        # create transcript segment embeddings and store in vector store
        audio_to_text_embedding = text_embedding_obj.create_text_embedding(audio_to_text_output)
